<x-layout>
    <main class="max-w-6xl mx-auto mt-6 lg:mt-20 space-y-6">
        <form method="POST" action="{{ route('login') }}" class="max-w-md mx-auto mt-10 p-10 bg-gray-200 rounded-md">
            @csrf

            <h1 class="flex items-center justify-center mb-5 font-bold">Login</h1>
